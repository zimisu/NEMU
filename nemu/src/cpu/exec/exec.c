...
make_group(group2_i_b,
	inv, inv, inv, inv,
	sal_rm_imm_b, shr_rm_imm_b, inv, sar_rm_imm_b)

/* 0xc1 */
make_group(group2_i_v,
	inv, inv, inv, inv,
	sal_rm_imm_v, shr_rm_imm_v, inv, sar_rm_imm_v)

/* 0xd0 */
make_group(group2_1_b,
	inv, inv, inv, inv,
	sal_rm_1_b, shr_rm_1_b, inv, sar_rm_1_b)

/* 0xd1 */
make_group(group2_1_v,
	inv, inv, inv, inv,
	sal_rm_1_v, shr_rm_1_v, inv, sar_rm_1_v)

/* 0xd2 */
make_group(group2_cl_b,
	inv, inv, inv, inv,
	sal_rm_cl_b, shr_rm_cl_b, inv, sar_rm_cl_b)

/* 0xd3 */
make_group(group2_cl_v,
	inv, inv, inv, inv,
	sal_rm_cl_v, shr_rm_cl_v, inv, sar_rm_cl_v)
...
/* 0x74 */	je_i_b, inv, jbe_i_b, ja_si_b,
...
/* 0xe8 */	call_si_v, jmp_rel_si_v, inv, jmp_rel_si_b,
...
/* 0xc8 */	inv, inv, movsx_rm2r_v, movsx_rm2r_v,
