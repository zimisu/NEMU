...
make_group(group2_i_b,
	inv, inv, inv, inv,
	sal_rm_imm_b, inv, inv, sar_rm_imm_b)

/* 0xc1 */
make_group(group2_i_v,
	inv, inv, inv, inv,
	sal_rm_imm_v, inv, inv, sar_rm_imm_v)

/* 0xd0 */
make_group(group2_1_b,
	inv, inv, inv, inv,
	sal_rm_1_b, inv, inv, sar_rm_1_b)

/* 0xd1 */
make_group(group2_1_v,
	inv, inv, inv, inv,
	sal_rm_1_v, inv, inv, sar_rm_1_v)

/* 0xd2 */
make_group(group2_cl_b,
	inv, inv, inv, inv,
	sal_rm_cl_b, inv, inv, sar_rm_cl_b)

/* 0xd3 */
make_group(group2_cl_v,
	inv, inv, inv, inv,
	sal_rm_cl_v, inv, inv, sar_rm_cl_v)
